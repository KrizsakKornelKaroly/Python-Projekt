...
haromszogablak.title("Kör kerülete és területe")
...
haromszogki.place(relx=0.03, rely=0.95, anchor=SW)
...
haromszogimage = (Image.open("Tervek\\Képek\\haromszog.jpg"))
...
haromszoga=Label(haromszogablak,text="\"a\" oldal" , bg="#6a92ef", fg="white", font="Arial 15", padx=15, pady=15)
...
haromszogb=Label(haromszogablak,text="\"b\" oldal", bg="#6a92ef", fg="white", font="Arial 15", padx=15, pady=15)
...
haromszogc=Label(haromszogablak,text="\"c\" oldal", bg="#6a92ef", fg="white", font="Arial 15", padx=15, pady=15)
