...
borablak.title("Borravaló kalkulátor")
borsugszov=Label(borablak,text="Összege:", bg="#6a92ef", fg="white", font="Arial 15", padx=15, pady=10)
borsugszov.grid(row=2, column=1)
bore = Entry(borablak, width=20, font="Arial 15", bg="#4162b0", fg="white")
bore.grid(row=2, column=2)
borsugszov1=Label(borablak,text="Borravaló(%):", bg="#6a92ef", fg="white", font="Arial 15", padx=15, pady=10)
...
borcanvas.grid(column=3, row=2, rowspan=10, padx=8, pady=20)
borimage = (Image.open("Program\\Összerakás\\Képek\\borravalo.jpg"))
